...
AISupport_Message_FireSupport_FiringOnSupportBase = {
	_message1 = format["[%1] Negative %2. We cannot fire that close to an AI Support base. Out.", AISupport_HQCallSign, (name player)];
...
AISupport_Message_FireSupport_Firing = {
	...
	_message1 = format ["[%1] %2, this is %1. %3 is firing on your target. Out.", AISupport_HQCallSign, (name player), _fireTeamCallSign];
...
AISupport_Message_AirSupport_Request = { 	 
	disableUserInput true;
	player playActionNow "Medic";			
	...
	_message4 = format ["[%1] Roger %2.  Hang tight at your location. We will see if we have a bird available. Out.", AISupport_HQCallSign, (name player)];
	...
	if(isDedicated) then {
		...
		["systemChatRequest", [_message3]] call ExileServer_system_network_send_broadcast; 
		sleep 3;
		["systemChatRequest", [_message4]] call ExileServer_system_network_send_broadcast; 		
	}
	else {
		systemChat(_message1); 
		sleep 1;
...
AISupport_Message_AirSupport_NoAvailableTeams = { 

	_message1 = format ["[%1] %2, this is %1. Over.", AISupport_HQCallSign, (name player)];
	_message2 = format ["[%1] Roger %2, this is %1. Over.", (name player), AISupport_HQCallSign];
	_message3 = format ["[%1] %2, that's a negative on the air support. Over.", AISupport_HQCallSign, (name player)];
	_message4 = format ["[%1] Copy %2. Out.", (name player), AISupport_HQCallSign];
...
AISupport_Message_AirSupport_InRoute = {
	params["_fireTeamCallSign"];

	_message1 = format ["[%1] %2, this is %1. Over.", AISupport_HQCallSign, (name player)];	
	_message2 = format ["[%1] Roger %2, this is %1. Over.", (name player), AISupport_HQCallSign];
	_message3 = format ["[%1] %2, we've got %3 inbound on your location. Over", AISupport_HQCallSign, (name player), _fireTeamCallSign];
	_message4 = format ["[%1] Copy %2. Out.", (name player), AISupport_HQCallSign];
...
AISupport_Message_AirSupport_OnLocation = {
	params["_fireTeamCallSign"];
...
AISupport_Message_AirSupport_RTB = {
	params["_fireTeamCallSign"];
...
AISupport_Message_Reinforcements_Request = { 	 
	disableUserInput true;
	player playActionNow "Medic";			
	...
	_message4 = format ["[%1] Roger %2.  Hang tight at your location. We will see if we have a team available. Over.", AISupport_HQCallSign, (name player)];
...
AISupport_Message_Reinforcements_NoAvailableTeams = { 

	_message1 = format ["[%1] %2, this is %1. Over.", AISupport_HQCallSign, (name player)];
	_message2 = format ["[%1] Roger %2, this is %1. Over.", (name player), AISupport_HQCallSign];
	_message3 = format ["[%1] %2, that's a negative on the reinforcements. Over.", AISupport_HQCallSign, (name player)];
	_message4 = format ["[%1] Copy %2. Out.", (name player), AISupport_HQCallSign];
...
AISupport_Message_Reinforcements_InRoute = {
	params["_fireTeamCallSign"];
	 
	_message1 = format ["[%1] %2, this is %1. Over.", AISupport_HQCallSign, (name player)];	
	_message2 = format ["[%1] Roger %2, this is %1. Over.", (name player), AISupport_HQCallSign];
	_message3 = format ["[%1] %2, we've got %3 inbound on your location with reinforcements.", AISupport_HQCallSign, (name player), _fireTeamCallSign];
	_message4 = format ["[%1] They're gonna need some smoke once they get close to your AO. Over.", AISupport_HQCallSign, _fireTeamCallSign];
	_message5 = format ["[%1] Copy %2. Out.", (name player), AISupport_HQCallSign];
	...
	if(isDedicated) then {
		...
		["systemChatRequest", [_message4]] call ExileServer_system_network_send_broadcast;  
		sleep 2;
		["systemChatRequest", [_message5]] call ExileServer_system_network_send_broadcast;  
	}
	else {
		sleep 8;
		systemChat(_message1); 
...
AISupport_Message_Reinforcements_OnLocation = {
	params["_fireTeamCallSign"];
...
AISupport_Message_Reinforcements_PopSmoke = {
	params["_fireTeamCallSign"];
...
AISupport_Message_Reinforcements_PopSmoke_Again = {
	params["_fireTeamCallSign"];
...
AISupport_Message_Reinforcements_PopSmoke_LastTime = {
	params["_fireTeamCallSign"];
...
AISupport_Message_Reinforcements_PopSmoke_RTB = {
	params["_fireTeamCallSign"];
