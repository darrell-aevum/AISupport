...
AIS_Message_FireSupport_FiringOnSupportBase = {
	...
	["errorToaster", "AI Support - Fire Mission", "Your target is too close to a support base."] call AIS_Client_fnc_SendMessage;				
};
...
AIS_Message_FireSupport_OutOfRange = {
	...
	["errorToaster", "AI Support - Fire Mission", "Your target is out of range of all firebases."] call AIS_Client_fnc_SendMessage;				
};
...
AIS_Message_FireSupport_Firing = {
	...
	["successToaster", "AI Support - Fire Mission", "Rounds are inbound on your target."] call AIS_Client_fnc_SendMessage;				
};
...
//	player playActionNow "Medic";			
	...
	_message4 = format ["[%1] Roger %2. We will see if we have a bird available. Out.", AIS_HQCallSign, (name player)];
...
AIS_Message_AirSupport_InRoute = {
    ...
    ["successToaster", "AI Support - Air Support", "Air Support is in route."] call AIS_Client_fnc_SendMessage;				        
};
