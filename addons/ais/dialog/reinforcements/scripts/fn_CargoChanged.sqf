	...
	for "_i" from 0 to (lbSize _cargoListBox - 1) do { 
		_cargoCost = _cargoCost + _cargoListBox lbValue _i; 
		_unitsTransporting = _unitsTransporting + _cargoListBox lbData _i;		
	};	 
	...
	_textCbo = ((findDisplay AIS_Dialog) displayCtrl (AIS_Dialog_Reinforcements_AddUnitToCargoTxt)); 
	_text = "";
