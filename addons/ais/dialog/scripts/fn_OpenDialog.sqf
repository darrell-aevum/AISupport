	...
	_serverTitleCbo ctrlSetStructuredText parseText format ["<t align='left'>%3 - [%1] %2</t><t align='right'><img  size='0.85' image='addons\ais\icons\respect.paa'/> %4   <img  size='0.75' image='addons\ais\icons\poptab_ca.paa'/> %5</t>",group player, _plr,_title, _playerRespect,_playerTabs];
